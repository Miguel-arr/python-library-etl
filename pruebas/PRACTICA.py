...
print(BasicsTransformOperations.show_head(formulas))

# ==========================
# 3. NORMALIZACIÓN DE DATOS
# ==========================

print("=== CONVERTIMOS A LISTA Y LA HACEMOS POR LA MISMA COLUMNA MANTENIENDO LA INFORMACIÓN DE LAS DEMÁS COLUMNAS INTACTA ===")
...
print(BasicsTransformOperations.show_head(df_formulas_normalizado))
print("\n")

# ======================
# 5. PREPARACIÓN DE ÍNDICES
# ======================
...
# ======================
# 6. ANÁLISIS DE MEDICAMENTOS INDIVIDUALES
# ======================

print("=== TOP 10 MEDICAMENTOS INDIVIDUALES ===")
# Filtrar y contar medicamentos individuales
...
print(BasicsTransformOperations.show_head(top_medicamentos, 10))
print("\n")

# ======================
# 7. ANÁLISIS DE COMBINACIONES DE MEDICAMENTOS
# ======================

# Agrupar medicamentos por fórmula para análisis de combinaciones
...
# print(contador_combinaciones)  # Comentado para evitar salida extensa
print("\n")
...
loader_carga_colombia.load_fact(df_formulas_normalizado, 'fact_formulas', foreign_keys2)
