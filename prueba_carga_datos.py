...
def test_petl_search():
    ...
    try:
        ...
        cotizante2 = ConvertOperations.convert_column_type(
                cotizante, 
                columns=['cedula'],
                dtype={'cedula': 'int'},
                show=0  # Mostrar todo el dataframe
    ...
    show=0  # Mostrar todo el dataframe
        ...
        df2.info()
        loader_oracle.load_dimension([medico2, personas, df2], ['dim_medico', 'dim_personas', 'fact'])
        foreign_keys={
                            "id_usuario": ("dim_personas", "cedula"),
                            "id_medico": ("dim_medico", "cedula"),
                            }
        loader_oracle.load_fact(df2, 'fact_prueba', foreign_keys)
